...
class AnonEnv:
    ...
    def load_flow(self, flowFile=None):
        ...
        self.eng.load_flow(os.path.join(ROOT_DIR, self.path_to_work_directory, flowFile))
            ...
            for i in range(100):
                ...
                if pos and speed:
                    print("%f, %f, %f" % (self.get_current_time(), pos, speed),
                          file=open(os.path.join(ROOT_DIR, self.path_to_log,
                                                 "first_vehicle_info_a", "first_vehicle_info_a_%d.txt" % i), "a"))
                if pos_2 and speed_2:
                    print("%f, %f, %f" % (self.get_current_time(), pos_2, speed_2),
                          file=open(os.path.join(ROOT_DIR, self.path_to_log,
                                                 "first_vehicle_info_b", "first_vehicle_info_b_%d.txt" % i), "a"))
                ...
                if pos_3 and speed_3:
                    print("%f, %f, %f" % (self.get_current_time(), pos_3, speed_3),
                          file=open(
                              os.path.join(ROOT_DIR, self.path_to_log,
                                           "first_vehicle_info_c", "first_vehicle_info_a_%d.txt" % i),
                              "a"))
                if pos_4 and speed_4:
                    print("%f, %f, %f" % (self.get_current_time(), pos_4, speed_4),
                          file=open(
                              os.path.join(ROOT_DIR, self.path_to_log,
                                           "first_vehicle_info_d", "first_vehicle_info_b_%d.txt" % i),
                              "a"))
